Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/db5ccfff6e80fbb4b94940f820ad364c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor = saturate(poiFragData.baseColor + (-0.013 /*_MainBrightness*/) * hueShiftAlpha.g);
				#endif
