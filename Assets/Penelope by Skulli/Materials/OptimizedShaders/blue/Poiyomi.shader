Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/9446982ab1a6ed44e9d40ff56571bb70"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float2 st = frac(poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(0.1,0.1,0,0).xy * _Time.x) * (300.0 /*_GlitterFrequency*/);
