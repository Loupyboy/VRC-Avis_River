Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/e96fa4698b5046e41b4d383ce8f1c826"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float metallic = (0.788 /*_MochieMetallicMultiplier*/);
				...
				#endif
				reflectionMask *= (0.268 /*_MochieReflectionStrength*/);
			...
			{
				float clearCoatMask = (0.058 /*_ClearCoatStrength*/);
				...
				#endif
				specularMask *= (1.0 /*_ClearCoatSpecularStrength*/);
				reflectionMask *= (0.435 /*_ClearCoatReflectionStrength*/);
