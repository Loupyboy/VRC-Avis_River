Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/a63fe6366c85c604f87ccef964204dbb"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor = saturate(poiFragData.baseColor + (0.161 /*_MainBrightness*/) * hueShiftAlpha.g);
				#endif
