Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/0b69bfd9b6980474880a89354e95c16c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				float3 heightOffset = (tex2Dlod(_VertexManipulationHeightMask, float4(poiUV(vertexUV(v, (0.0 /*_VertexManipulationHeightMaskUV*/)), float4(1,1,0,0)) + float4(0,0,0,0) * _Time.x, 0, 0))[(0.0 /*_VertexManipulationHeightMaskChannel*/)] - (0.0 /*_VertexManipulationHeightBias*/)) * ((0.001 /*_VertexManipulationHeight*/) + ALHeight) * o.normal;
				#else
				float3 heightOffset = ((0.001 /*_VertexManipulationHeight*/) + ALHeight) * o.normal;
				#endif
