Shader "Hidden/Locked/.poiyomi/Poiyomi 8.2/Poiyomi Pro/ec39ef0322d5ddd4d9b1b472db133bd9"
{
	Properties
	{
		[HideInInspector] shader_master_label ("<color=#E75898ff>Poiyomi 8.2.027</color>", Float) = 0
		...
		[ThryIntRange]_TPS_Channel("Channel--{tooltip:Channel of the penetrator. Channel -1 is DPS Channel 1}", Range(-1,8)) = 0
		...
		[HideInInspector][ThryWideEnum(Replace, 0, Multiply, 2, Screen, 6, Linear Dodge(Add), 8, Overlay, 9, Mixed, 20)] _ALDecalGlobalMaskBlendType ("Blending", Int) = 2
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_ANISOCOLORMAP) || !defined(OPTIMIZER_ENABLED)
				float4 specMap = POI2D_SAMPLER_PAN(_AnisoColorMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_AnisoColorMapUV*/)], float4(0.01,0.01,0,0)), float4(0,0,0,0));
				#else
				...
				#endif
				float spec0 = calculateAnisotropics(lerp(poiMesh.binormal[1], poiMesh.tangent[1], (0.0 /*_Aniso0SwitchDirection*/)), (0.0 /*_Aniso0Offset*/) +(0.0 /*_Aniso0OffsetMapStrength*/) * specMap.a, poiMesh.normals[1], poiCam.viewDir, poiLight.direction, (0.0 /*_Aniso0Power*/) * 1000, (1.0 /*_Aniso0Strength*/), shadowMask);
				...
				float3 spec0Color = specMap.rgb * float4(1,1,1,1);
				float3 spec1Color = specMap.rgb * float4(1,1,1,1);
				float3 finalSpec = saturate(saturate(spec0 * spec0Color) + saturate(spec1 * spec1Color)) * lerp(1, poiFragData.baseColor, (0.75 /*_AnisoUseBaseColor*/)) * lerp(dot(poiLight.directColor, float3(0.299, 0.587, 0.114)), poiLight.directColor, (1.0 /*_AnisoUseLightColor*/));
				float3 baseColor = poiFragData.baseColor;
				poiFragData.baseColor = lerp(poiFragData.baseColor, spec1Color * lerp(1, baseColor, (0.75 /*_AnisoUseBaseColor*/)) * lerp(dot(poiLight.directColor, float3(0.299, 0.587, 0.114)), poiLight.directColor, (1.0 /*_AnisoUseLightColor*/)), (0.0 /*_AnisoReplace*/) * spec1);
				poiFragData.baseColor = lerp(poiFragData.baseColor, spec0Color * lerp(1, baseColor, (0.75 /*_AnisoUseBaseColor*/)) * lerp(dot(poiLight.directColor, float3(0.299, 0.587, 0.114)), poiLight.directColor, (1.0 /*_AnisoUseLightColor*/)), (0.0 /*_AnisoReplace*/) * spec0);
				...
				if ((1.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					{
						float vSpec0 = calculateAnisotropics(lerp(poiMesh.binormal[1], poiMesh.tangent[1], (0.0 /*_Aniso0SwitchDirection*/)), (0.0 /*_Aniso0Offset*/) +(0.0 /*_Aniso0OffsetMapStrength*/) * specMap.a, poiMesh.normals[1], poiCam.viewDir, poiLight.vDirection[index], (0.0 /*_Aniso0Power*/) * 1000, (1.0 /*_Aniso0Strength*/), poiLight.vAttenuationDotNL[index]);
						...
						float3 vSpec0Color = specMap.rgb * float4(1,1,1,1);
						float3 vSpec1Color = specMap.rgb * float4(1,1,1,1);
						poiLight.finalLightAdd += max(0, saturate(saturate(vSpec0 * spec0Color) + saturate(vSpec1 * spec1Color)) * lerp(1, poiFragData.baseColor, (0.75 /*_AnisoUseBaseColor*/)) * lerp(dot(poiLight.vColor[index], float3(0.299, 0.587, 0.114)), poiLight.vColor[index], (1.0 /*_AnisoUseLightColor*/)) * (1.0 /*_AnisoAdd*/));
						poiFragData.baseColor = lerp(poiFragData.baseColor, spec1Color * lerp(1, baseColor, (0.75 /*_AnisoUseBaseColor*/)) * lerp(dot(poiLight.vColor[index], float3(0.299, 0.587, 0.114)), poiLight.vColor[index], (1.0 /*_AnisoUseLightColor*/)), (0.0 /*_AnisoReplace*/) * vSpec1);
						poiFragData.baseColor = lerp(poiFragData.baseColor, spec0Color * lerp(1, baseColor, (0.75 /*_AnisoUseBaseColor*/)) * lerp(dot(poiLight.vColor[index], float3(0.299, 0.587, 0.114)), poiLight.vColor[index], (1.0 /*_AnisoUseLightColor*/)), (0.0 /*_AnisoReplace*/) * vSpec0);
					}
					#endif
				}
				return float3(0, 0, 0);
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float3 lowColor = float4(0,1,0.8878458,1).rgb * poiThemeColor(poiMods, float4(0,1,0.8878458,1).rgb, (0.0 /*_ALDecalVolumeColorLowThemeIndex*/));
				float3 midColor = float4(0,1,0,1).rgb * poiThemeColor(poiMods, float4(0,1,0,1).rgb, (0.0 /*_ALDecalVolumeColorMidThemeIndex*/));
				float3 highColor = float4(0.4117943,1,0,1).rgb * poiThemeColor(poiMods, float4(0.4117943,1,0,1).rgb, (0.0 /*_ALDecalVolumeColorHighThemeIndex*/));
			...
			void ApplyAudioLinkVolumeColor(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float3 lowColor = float4(0.1542947,1,0.6875339,1).rgb * poiThemeColor(poiMods, float4(0.1542947,1,0.6875339,1).rgb, (1.0 /*_ALVolumeColorLowThemeIndex*/));
				float3 midColor = float4(0.5831007,0.8760344,0.5831007,1).rgb * poiThemeColor(poiMods, float4(0.5831007,0.8760344,0.5831007,1).rgb, (0.0 /*_ALVolumeColorMidThemeIndex*/));
				...
				float3 emissionColor = lerp(lowColor * (1.56 /*_ALLowEmission*/), midColor * (0.0 /*_ALMidEmission*/), saturate(volume * 2));
				...
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor, customBlend(poiFragData.baseColor, volumeColor, (0.0 /*_ALVolumeColorBlendType*/)), saturate((1.0 /*_ALVolumeColorBlendAlpha*/) * poiMods.audioLinkAvailable));
				#endif
			}
			#endif
			#endif
			...
			{
				float2 st = frac(poiMesh.uv[(4.0 /*_GlitterUV*/)] + float4(0,2,0,0).xy * _Time.x) * (200.0 /*_GlitterFrequency*/);
				...
				half3 glitterColor = poiThemeColor(poiMods, float4(1,0.9538098,0,1), (0.0 /*_GlitterColorThemeIndex*/));
				...
				switch((0.0 /*_GlitterMode*/))
				{
					...
					if ((20.0 /*_GlitterSpeed*/) > 0)
					{
						randomRotation = randomFloat3WiggleRange(randoPoint, (90.0 /*_GlitterAngleRange*/), (20.0 /*_GlitterSpeed*/));
					}
					else
					{
					...
					float brightness = sin((_Time.x + offset) * (20.0 /*_GlitterSpeed*/)) * (20.0 /*_glitterFrequencyLinearEmissive*/) - ((20.0 /*_glitterFrequencyLinearEmissive*/) - 1);
				...
				{
					glitterColor.rgb = hueShift(glitterColor.rgb, (0.0 /*_GlitterHueShift*/) + _Time.x * (1.0 /*_GlitterHueShiftSpeed*/));
				}
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.2122307,1,0,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.2122307,1,0,1).a;
